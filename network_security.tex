...
\begin{equation}
 p_{n_E} = \left. {p_{E_i}^{n_E}} \cdot {(1-p_{E_i})^{N_E-n_E} \cdot C(N,n_E)} \right| _{N_E = min(E,N)}
\end{equation}
...
\begin{align*}
 ...
 n_E &= 4 & n_E &= 11 & n_E &= 34 \\
 p_{n \ge 4} &= 4.1^{-5} & 
 p_{n \ge 11} &= 1.37 \cdot 10^{-13} & 
 p_{n \ge 34} &= 7.36 \cdot 10^{-67}
\end{align*}
...
\begin{align*}
 ...
 E &= 11 & E &= 100 & E &= 101 \\
 n_E &= 4 & n_E &= 21 & n_E &= 68 \\
 p_{n \ge 4 } &= 1.36 \cdot 10^{-13} & 
 p_{n \ge 21} &= 9.34035 \cdot 10^{-54} & 
 p_{n \ge 68} &= 7.2 \cdot 10^{-125}
\end{align*}

...
\begin{equation}
 p_{n_E} \leq \left. \left( \prod_{i=1}^{n_E}{p_{E_i}} \right) \cdot {(1-p_{E_{n_E}})^{N-n_E} \cdot C(N,n_E)} \right| _{N_E = min(E,N)}
\end{equation}
...
\begin{align*}
 ...
 E &= 11 & E &= 100 & E &= 101 \\
 n_E &= 4 & n_E &= 11 & n_E &= 34 \\
 p_{n \ge 4} &\leq 6.0 \cdot 10^{-5} & 
 p_{n \ge 11} &\leq 6.659 \cdot 10^{-12} & 
 p_{n \ge 34} &\leq 3.0 \cdot 10^{-64}
\end{align*}
...
\begin{align*}
 ...
 E &= 11 & E &= 100 & E &= 101 \\
 n_E &= 4 & n_E &= 21 & n_E &= 68 \\
 p_{n \ge 4 } &\leq 1.9 \cdot 10^{-6} & 
 p_{n \ge 21} &\leq 6.657 \cdot 10^{-12} & 
 p_{n \ge 68} &\leq 3.9 \cdot 10^{-105}
\end{align*}
